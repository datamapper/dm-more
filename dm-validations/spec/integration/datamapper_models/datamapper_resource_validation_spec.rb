...
# TODO: these examples need reworking, too
# half of them no longer necessary since
# we have a lot of integration examples anyway,
# but those at the end with subclasses + validation,
# and associations, are important
