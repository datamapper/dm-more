...
pure Ruby classes, require 'dm-validations' and then include DataMapper::Validations
module like so:
...
2) Using auto-validations, please see DataMapper::Validations::AutoValidations
...
DataMapper::Validations::ValidationErrors object that is available through each of
